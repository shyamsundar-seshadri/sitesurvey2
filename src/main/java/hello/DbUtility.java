...
public class DbUtility {
	...
	public static Document getDocFromMap(Map<String, Object> map) {
		...
		for (String key : map.keySet()) {
			...
			if (o instanceof java.util.Map)
				return getDocFromMap((Map<String, Object>) o);
			else
				doc.put(key, o);
		}
		return doc;
	...
	public static long updateDoc(MongoDatabase db, String name, Document src,
	...
	public static String insertDoc(MongoDatabase db, String name,
			Map<String, Object> map) {
		String rc = null;
		Document doc = getDocFromMap(map);
	...
	public static MongoCursor<Document> queryDoc(MongoDatabase db, String name,
			Map<String, Object> map) {
